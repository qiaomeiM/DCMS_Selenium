...
public class Mail {
    ...
    public static String myEmailAccount = "yyj15230839058@163.com";
    public static String myEmailPassword = "aomenfeng1";
    ...
    public static MimeMessage sendMail(String receiver,String subject,String content) throws Exception{
    	...
    	// 2. From: 发件人
        message.setFrom(new InternetAddress(myEmailAccount, "杨跃娟（发件人）", "UTF-8"));
