...
public class MailUtil {
    ...
    static String from = "ÑîÔ¾¾ê";

    static String user = "yyj15230839058@163.com";
    static String password = "aomenfeng1";//ÊÚÈ¨Âë
   ...
   public static void test1(){
    ...
    public static void main(String args[]) throws UnsupportedEncodingException
    {
    	...
    	MailUtil.sendEmail("yyj15230839058@163.com", "ceshi", "ce");
