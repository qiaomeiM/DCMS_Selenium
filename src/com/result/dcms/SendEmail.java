...
public class SendEmail {
    ...
    public static String myEmailAccount = "15231181069@163.com";
    public static String myEmailPassword = "051655km";
    ...
    public static MimeMessage sendMail(String receiver,String subject,String content) throws Exception{
    	...
    	// 2. From: 发件人
        message.setFrom(new InternetAddress(myEmailAccount, "李娅", "UTF-8"));
...
//    	  sendMail("15231181069@163.com","yanzhen","成功了");
//    }
}
